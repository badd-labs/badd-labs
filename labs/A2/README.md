...
Exercise 5: Ether bank under deposit from strangers
---

Extend your solution in Exercise 4 to realize the following: 
...
Extend your solution in Exercise 4 to handle deposits from users other than Alice or Bob: 
